...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 19, 6, 0),
    end: new Date(2025, 4, 19, 8, 0),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 19, 8, 30),
    end: new Date(2025, 4, 19, 10, 0),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 19, 10, 15),
    end: new Date(2025, 4, 19, 11, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 19, 12, 0),
    end: new Date(2025, 4, 19, 14, 30),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2025, 4, 20, 7, 0),
  ...
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 20, 16, 0),
    end: new Date(2025, 4, 20, 17, 30),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 4, 22, 7, 0),
    end: new Date(2025, 4, 22, 9, 0),
  },
  ...
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2025, 4, 22, 17, 0),
    end: new Date(2025, 4, 22, 18, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 23, 7, 0),
...

  {
    ...
    end: new Date(2025, 4, 23, 12, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 4, 23, 15, 30),
    end: new Date(2025, 4, 23, 17, 30),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 4, 23, 18, 0),
    end: new Date(2025, 4, 23, 19, 15),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 4, 21, 6, 30),
